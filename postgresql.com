...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-09-18T18:26:47.539656" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgbadger-v120-released-2509/">pgBadger v12.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-09-13 by MigOps</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgconfnyc-2022-sep-22-23-registration-closing-soon-2508/">PGConf.NYC 2022 (Sep 22-23) Registration Closing Soon!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-09-09 by United States PostgreSQL Association</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-15-beta-4-released-2507/">PostgreSQL 15 Beta 4 Released!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-09-08 by PostgreSQL Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/cloudnativepg-1170-1162-and-1154-released-2506/">CloudNativePG 1.17.0, 1.16.2 and 1.15.4 Released!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-09-07 by CloudNativePG</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/call-for-new-members-for-the-community-code-of-conduct-committee-2505/">Call for New Members for the Community Code of Conduct Committee</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-09-06 by PostgreSQL Code of Conduct Committee</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pI"> What is LATERAL, what is it for, and how can one use it?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#x27;depesz&#x27; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-09-18</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pG"> PSQL Phriday: A Monthly Blog Event for the PostgreSQL Community</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ryan Booz</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-09-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pF"> pgagroal 1.5.0 released!</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pD"> PostgreSQL – how to detect and solve memory availability issues</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Emil Shkolnik</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-09-13</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pC"> Working With Snapshots in PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pB"> What is an inner join in SQL? And what is an outer join?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5pA"> git diff and git log and dots</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5py"> An introduction to connection-profiler</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Frits Hoogland</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-09-12</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5px"> Distributed Postgres goes full open source with Citus: why, what &amp; how</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jelte Fennema</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-09-12</li>
            </ul>
          </div>
        </div>
